...
const DemoSection = ({ lang = 'en' }) => { // Default lang to 'en' if not provided
    ...
    const t = (texts) => {
        ...
        const translations = {
            // Input Section Title
            yourText: { en: "Your Text", "zh-cn": "您的文本", es: "Tu Texto", /* ... other langs */ },
            inputPlaceholder: { en: "Enter your informal text here...", "zh-cn": "在这里输入您的非正式文本...", es: "Ingrese su texto informal aquí...", /* ... */ },
            // Output Section Title
            formalizedVersion: { en: "Formalized Version", "zh-cn": "正式版本", es: "Versión Formalizada", /* ... */ },
            outputPlaceholder: { en: "Your formalized text will appear here.", "zh-cn": "您的正式文本将显示在这里。", es: "Su texto formalizado aparecerá aquí.", /* ... */ },
            // Buttons
            copy: { en: "Copy", "zh-cn": "复制", es: "Copiar", /* ... */ },
            copied: { en: "Copied!", "zh-cn": "已复制!", es: "¡Copiado!", /* ... */ },
            formalize: { en: "Formalize Text", "zh-cn": "格式化文本", es: "Formalizar Texto", /* ... */ },
            formalizing: { en: "Formalizing...", "zh-cn": "正在格式化...", es: "Formalizando...", /* ... */ },
            // Error Message
            errorText: { en: "Sorry, an error occurred. Please try again.", "zh-cn": "抱歉，发生错误。请重试。", es: "Lo siento, ocurrió un error. Por favor, inténtalo de nuevo.", /* ... */ },
        };
